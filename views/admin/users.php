...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        if ($name && $email && $password) {
            ...
            $check->execute([$email]);
            if ($check->fetch()) {
                header('Location: /irms/views/admin/users.php?error=' .
            ...
            header('Location: /irms/views/admin/users.php?success=' .
...
<div class="d-flex">
    ...
    <div class="sidebar d-flex flex-column py-3">
        ...
        <nav class="flex-column nav">
            ...
            <a href="/irms/views/admin/users.php" class="nav-link active">
