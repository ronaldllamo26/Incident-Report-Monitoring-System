...
<div class="brand-bar">
    <div class="container d-flex justify-content-between align-items-center">
        <a href="/irms/index.php" class="text-white text-decoration-none fw-semibold">
        ...
        <div class="col-lg-8">
            ...
            <div class="alert alert-info d-flex gap-2 py-2 mb-4">
                ...
                <div class="small">
                    ...
                    para ma-monitor ang status ng iyong report.
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-muted small">
                    ...
                    Ang mga may <span class="text-danger">*</span> ay required.
                </p>
            </div>
                    ...
                    <form action="/irms/controllers/AnonReportController.php"
                        ...
                        <div class="mb-4 p-3 rounded"
                            ...
                            <p class="text-muted small mb-3">
                                Para makontak ka namin kung kailangan ng karagdagang impormasyon.
                                Hindi ito ipapakita sa publiko.
                            </p>
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <input type="text" name="anon_name"
                                           class="form-control form-control-sm"
                                           placeholder="Pangalan (optional)">
                                </div>
                                <div class="col-md-4">
                                    <input type="email" name="anon_email"
                                           class="form-control form-control-sm"
                                           placeholder="Email (optional)">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="anon_phone"
                                           class="form-control form-control-sm"
...
function doSearch(query) {
    ...
    fetch('https://nominatim.openstreetmap.org/search' +
          ...
          '&q=' + encodeURIComponent(query) + '&countrycodes=ph', {
        headers: { 'Accept-Language': 'en', 'User-Agent': 'IRMS-System' }
    })
    ...
    .then(function(data) {
        ...
        if (!data.length) {
            resultsBox.innerHTML =
                '<div class="list-group-item text-muted small">' +
                'Walang nahanap. Subukan ng ibang address.</div>';
            return;
        }
...
function useMyLocation(event) {
    ...
    btn.disabled  = true;
    btn.innerHTML =
        '<span class="spinner-border spinner-border-sm me-1"></span>Kumuha ng lokasyon...';
